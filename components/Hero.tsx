    ...
    <section id="home" className="relative w-full h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        <motion.h2
          ...
          className="text-xl md:text-2xl font-light mb-4 uppercase tracking-[0.2em] text-primary-accent"
        >
        ...
        <motion.h1
          ...
          className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight tracking-tight shadow-md"
        >
          山东万润集团 <br />
        ...
        <motion.p
          ...
          className="max-w-2xl mx-auto text-lg md:text-xl text-gray-200 mb-12 font-light"
        >
