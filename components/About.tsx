          ...
          <div className="space-y-8">
            ...
            <div className="text-gray-600 leading-relaxed space-y-6 text-justify">
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded border-l-4 border-primary-accent">
                  <div className="w-2 h-2 rounded-full bg-primary-accent"></div>
                  <span className="font-bold text-primary">客户至上</span>
                </div>
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded border-l-4 border-primary-accent">
                  <div className="w-2 h-2 rounded-full bg-primary-accent"></div>
                  <span className="font-bold text-primary">追求卓越</span>
                </div>
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded border-l-4 border-primary-accent">
                  <div className="w-2 h-2 rounded-full bg-primary-accent"></div>
                  <span className="font-bold text-primary">诚信经营</span>
                </div>
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded border-l-4 border-primary-accent">
                  <div className="w-2 h-2 rounded-full bg-primary-accent"></div>
                  <span className="font-bold text-primary">持续创新</span>
                </div>
              </div>
            </div>
